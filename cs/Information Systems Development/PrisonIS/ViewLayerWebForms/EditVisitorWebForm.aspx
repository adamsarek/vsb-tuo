<%@ Page Title="Upravit návštěvníka" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditVisitorWebForm.aspx.cs" Inherits="ViewLayerWebForms.EditVisitorWebForm" %>
    ...
    <div class="center">
        <div class="grid-gap v-grid grid-item">
            ...
            <div class="v-grid grid">
                <asp:Button id="EditVisitorButton" OnClick="EditVisitor_Click" Text="Upravit návštěvníka" runat="server"></asp:Button>
            </div>
        </div>
    </div>
</asp:Content>
